...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'plugin.manager.migrate.cckfield' => 'getPlugin_Manager_Migrate_CckfieldService',
    ...
    public function getPlugin_CacheClearerService($lazyLoad = true)
    {
        ...
        $instance->addCachedDiscovery($this->get('plugin.manager.migrate.cckfield'));
    ...
    /**
     * Gets the 'plugin.manager.migrate.cckfield' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getPlugin_Manager_Migrate_CckfieldService()
    {
        $this->services['plugin.manager.migrate.cckfield'] = $instance = new \Drupal\migrate_drupal\Plugin\MigratePluginManager('cckfield', $this->get('container.namespaces'), $this->get('cache.discovery'), $this->get('module_handler'));

        $instance->_serviceId = 'plugin.manager.migrate.cckfield';
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'migrate_example_setup' => array(
                    'type' => 'module',
                    'pathname' => '/migrate_example_setup.info.yml',
                    'filename' => NULL,
                ),
                'migrate_plus' => array(
                    'type' => 'module',
                    'pathname' => 'modules/migrate_plus/migrate_plus.info.yml',
            ...
            'container.namespaces' => array(
                ...
                'Drupal\\migrate_drupal' => 'core/modules/migrate_drupal/src',
                'Drupal\\migrate_example_setup' => '//src',
                'Drupal\\migrate_plus' => 'modules/migrate_plus/src',
